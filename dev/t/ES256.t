...
=== TEST: Token Based Authentication (alg: ES256, base64 encoded secret)
            ...
            jwt_secret = {
                {
                    key = "service A",
                    algorithm = alg,
                    rsa_public_key = jwt_parser.base64_encode(es256_public_key),
                    consumer = {
...
=== TEST: Token Based Authentication (alg: ES256, non-base64 encoded secret)
--- http_config eval: $t::Util::HttpConfig
--- config
location = /t2 {
    default_type 'application/json';
            ...
            jwt_secret = {
                {
                    key = "service A",
                    algorithm = alg,
                    rsa_public_key = es256_public_key,
                    consumer = {
                        id = "68aca0ee-ca34-4fe8-8bb4-3657eaf7508c",
                        custom_id = "custom_id_1",
                        username ="David"

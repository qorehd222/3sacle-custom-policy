...
local version_num = require("custom.openssl.version").version_num
...
local _M = {
  _VERSION = '0.6.2',
  bn = require("custom.openssl.bn"),
  cipher = require("custom.openssl.cipher"),
  digest = require("custom.openssl.digest"),
  hmac = require("custom.openssl.hmac"),
  kdf = require("custom.openssl.kdf"),
  pkey = require("custom.openssl.pkey"),
  objects = require("custom.openssl.objects"),
  rand = require("custom.openssl.rand"),
  version = require("custom.openssl.version"),
  x509 = require("custom.openssl.x509"),
  altname = require("custom.openssl.x509.altname"),
  chain = require("custom.openssl.x509.chain"),
  csr = require("custom.openssl.x509.csr"),
  crl = require("custom.openssl.x509.crl"),
  extension = require("custom.openssl.x509.extension"),
  name = require("custom.openssl.x509.name"),
  store = require("custom.openssl.x509.store"),
}

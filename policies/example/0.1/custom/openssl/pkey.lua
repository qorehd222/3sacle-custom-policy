...
local rsa_macro = require "custom.openssl.include.rsa"
...
local rsa_lib = require "custom.openssl.rsa"
local ec_lib = require "custom.openssl.ec"
local ecx_lib = require "custom.openssl.ecx"
local objects_lib = require "custom.openssl.objects"
local jwk_lib = require "custom.openssl.aux.jwk"

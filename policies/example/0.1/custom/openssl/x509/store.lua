...
local x509_vfy_macro = require "custom.openssl.include.x509_vfy"
local x509_lib = require "custom.openssl.x509"
local chain_lib = require "custom.openssl.x509.chain"
local crl_lib = require "custom.openssl.x509.crl"
